...
INSERT INTO `user` (`id`, `name`, `email`, `phone`, `pass`, `address`,`Kebelename`,`Age`) VALUES
(1, 'Ameen Khan', 'ameenkhan07@gmail.com', 2147483647, 'qwerty', 'Jamia nagar','Kochi',34),
(2, 'Abhishek Bhatnagar', 'abhishek@gmail.com', 999999999, 'qwerty', 'Ghaziabad','Kochi',24),
(3, 'Anzal', 'anzal@gmail.com', 2147483647, 'qwerty', 'Batla House','Kochi',21),
(4, 'Manaf', 'manaf@gmail.com', 2147483647, 'qwerty', 'Shaheen Bagh','Kochi',43),
(5, 'abc', 'abc@gmail.com', 2147483647, 'qwerty', 'Jamia','Kochi',35),
(6, 'xyz', 'xyz@gmail.com', 2147483647, 'qwerty', 'Dwarka','Kochi',67),
(7, 'akshit', 'akshit@gmail.com', 123456789, 'qwerty', 'qwe','Kochi',44);
